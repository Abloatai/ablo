...
{/* AUTO-GENERATED from packages/sync-engine/docs/guarantees.md -- edit there, then run `npm run build:docs`. */}
...
receipts, realtime fanout, and audit. See [Connect Your Database](/data-sources).
