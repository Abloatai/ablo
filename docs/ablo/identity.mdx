...
{/* AUTO-GENERATED from packages/sync-engine/docs/identity.md -- edit there, then run `npm run build:docs`. */}
...
runs the [Coordinating long agent work](https://github.com/Abloatai/ablo/blob/main/README.md#coordinating-long-agent-work)
