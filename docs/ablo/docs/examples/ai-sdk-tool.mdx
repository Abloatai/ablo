---
title: "AI SDK Tool"
description: "Give an AI SDK agent safe access to the same typed Ablo resources as your backend."
sidebar:
  icon: wrench
---
...
[Context](/context) assembles them and formats an optional user message
