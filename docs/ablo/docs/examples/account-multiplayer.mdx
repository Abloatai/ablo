---
title: "Account multiplayer"
description: "Assemble account isolation, two humans, one agent, presence and reconnect in one runnable app."
---
...
[Groups and shared context](/groups).
...
cleanup cannot dispose an instance that a later setup reuses. See [React](/react)
...
[claim permissions](/coordination#claim-permissions): selecting claim fields
