---
title: "Introduction"
description: "Coordination infrastructure for agents, applications, services, and people working on shared state"
sidebar:
  icon: book-open
seo:
  title: ""
...
- [Installation](/installation) — install Ablo, declare the shared models,
  and create a client.
- [Basic usage](/basic-usage) — read, write, and coordinate one operation.
- [Comparison](/comparison) — see how Ablo relates to PostgreSQL locks,
  Redis reservations, queues, workflow engines, and rolling your own.
- [Choose the Ablo operation](/implement) — route an existing use case to
...
index, or connect an assistant to the [documentation MCP server](/mcp). The
...
[account multiplayer reference](/examples/account-multiplayer).
