...
|---|---|---|---|
| Agent execution | [Anthropic Sandbox Runtime](/integrations/sandbox-runtime) | Available | Restricting the filesystem, network, sockets, and inherited authority of an agent process |
| Long-running records | [Temporal](/integrations/temporal) | Available | Durable Workflows, Activity retries, timers, cancellation, and durable AI SDK calls |
| Long-running records | [Inngest](/integrations/inngest) | Available | Event-driven durable functions, retriable steps, flow control, and checkpointed AI SDK calls |
...
Use [Anthropic Sandbox Runtime](/integrations/sandbox-runtime) to enforce the
