---
title: "GraphQL.js over an existing backend"
description: "Keep an existing GraphQL API while one named domain operation coordinates its shared-row effects through Ablo."
---
