...
description: "One schema becomes typed clients, agent writes, interface reads, and the hosted push."
sidebar:
  icon: braces
---
...
Database](/data-sources) (the single source of truth): a development branch
