---
title: "Coordination"
description: "Claim mechanics and the API behind them: who holds a row, who is waiting, and how the line moves."
sidebar:
  icon: handshake
---
...
> turn. See [sessions](/sessions#agent-sessions-rk_) for the minting flow.
>
...
See [Debugging & Logs](/debugging) for the setup, the event shapes, a
