---
title: "CLI"
description: "Scaffold a schema, connect a database, push it, and watch it sync."
sidebar:
  icon: terminal
---
...
source of truth, expose a [Data Source endpoint](/data-sources) and keep DB
...
or copy production rows. Read [Branch-first development](/branch-development)
