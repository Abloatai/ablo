---
title: "Transports"
description: "Transport follows identity: API-key services use HTTP and scoped sessions use one multiplexed WebSocket."
sidebar:
  icon: network
---
...
See [Sessions](/sessions) for issuance and renewal, [Agents](/agents) for
worker patterns, and [Options](/options) for connection tuning.
