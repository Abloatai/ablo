---
title: "FAQ"
description: "Short answers to the implementation choices developers encounter most often."
sidebar:
  icon: circle-help
---
...
[React client](/react) adds live state and presence for human interfaces.
