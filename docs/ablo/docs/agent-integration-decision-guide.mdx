---
title: "Agent Integration Decision Guide"
description: "Choose the smallest Ablo integration route and the proof required for each guarantee."
sidebar:
  icon: route
---
...
Continue with the [Integration Guide](/integration-guide) for setup and API
details, or [Concurrency Convention](/concurrency-convention) for the exact
guarding rules.
