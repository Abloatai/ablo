---
title: "Installation"
description: "Install Ablo, declare the models participants share, and create a typed client."
sidebar:
  icon: package-plus
---
...
Continue to [Basic usage](/basic-usage) to read, write, and coordinate one
operation. Use the [full Quickstart](/quickstart) when you need the detailed
