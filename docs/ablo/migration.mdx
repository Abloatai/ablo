...
{/* AUTO-GENERATED from packages/sync-engine/docs/migration.md -- edit there, then run `npm run build:docs`. */}

The breaking-changes-first companion to the [Changelog](/changelog). The
