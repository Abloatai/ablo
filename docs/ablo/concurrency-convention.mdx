...
{/* AUTO-GENERATED from packages/sync-engine/docs/concurrency-convention.md -- edit there, then run `npm run build:docs`. */}
...
> three-layer mechanics live in [`coordination.md`](/coordination).
