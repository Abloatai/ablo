...
{/* AUTO-GENERATED from packages/sync-engine/docs/api.md -- edit there, then run `npm run build:docs`. */}
...
The [coordination MCP server](/mcp) (`@ablo/mcp`) is this same surface
