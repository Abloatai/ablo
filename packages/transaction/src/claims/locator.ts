...
import type { ClaimPart, ModelTarget, TargetRef, WireClaim } from '../coordination/schema.js';
import {
  fieldSelection,
  type FieldRef,
  type FieldSelector,
} from '../schema/fieldRef.js';
import { partName } from '../coordination/schema.js';
