...
import { createTransactionClient } from './headless.js';
import type { PendingWrite } from '../commit/confirmation/pendingWrite.js';
...
describe('createTransactionClient', () => {
  it('composes the transaction seam with the existing typed HTTP resources', () => {
    ...
    expect(typeof client.orders.read).toBe('function');
