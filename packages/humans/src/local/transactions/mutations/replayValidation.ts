 ...
 * transactions — the legacy local mutation journal (`type: 'queue'`) and delta-await
...
/**
 * The shape of one entry in the persisted legacy local mutation journal — an item of
