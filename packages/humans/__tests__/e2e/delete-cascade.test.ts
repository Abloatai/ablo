...
async function batchAck(ops: Record<string, unknown>[]): Promise<{ lastSyncId: number; errors?: unknown[] }> {
...
function connectAndCollect(): Promise<{ ws: WebSocket; deltas: Record<string, unknown>[] }> {
