...
const TITLES = {
  ...
  faq: 'FAQ',
  implement: 'Choose the Ablo operation',
  'api-keys': 'API Keys',
  mcp: 'Model Context Protocol',
  identity: 'Identity and credentials',
  groups: 'Groups and shared context',
  ...
  'examples/evidence-backed-document-pipeline': 'Evidence-Backed Document Pipeline',
...
const ICONS = {
  ...
  'examples/evidence-backed-document-pipeline': 'file-check-2',
