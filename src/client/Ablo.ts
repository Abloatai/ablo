...
import { AbloClaimedError, AbloError, AbloAuthenticationError, AbloConnectionError, AbloValidationError, translateHttpError } from '../errors.js';
...
export interface ModelClient<T = Record<string, unknown>> {
  ...
  create(
    ...
    options?: ModelMutationOptions & { readonly id?: string | null },
