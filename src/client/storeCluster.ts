 ...
 */
export const kStoreCluster: unique symbol = Symbol('ablo.humans.storeCluster');
 ...
 */
function isReactiveSocket(
  transport: unknown,
): transport is SyncWebSocket<DefaultCollaborationEvents> {
...
export function buildStoreCluster(
  context: PluginContext<InternalAbloOptions<SchemaRecord>>,
): StoreCluster | null {
  ...
  let registryForMetadata: ModelRegistry | undefined;
