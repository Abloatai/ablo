...
import { M1 } from './helpers/M1';
import { getActiveRegistry, hasActiveRegistry } from './ModelRegistry';
...
interface SyncStoreRef {
  ...
  findById<T extends Model>(modelClass: abstract new (...args: never[]) => T, id: string): T | undefined;
