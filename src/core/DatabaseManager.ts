...
import { openIDBWithTimeout } from './openIDBWithTimeout';
...
export class DatabaseManager {
  ...
  async calculateDatabaseInfo(
    ...
    // Get schema hash from global ModelRegistry instance
    const modelRegistry = (globalThis as any).__modelRegistry;
    const schemaHash = modelRegistry?.getSchemaHash() || 'no-registry-hash';
