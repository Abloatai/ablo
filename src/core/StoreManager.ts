...
import { SyncActionStore } from '../stores/SyncActionStore';
...
export class StoreManager {
  ...
  markAllStoresAsClosing(): void {
    ...
    if (this.syncactionStore) {
      // SyncActionStore extends ObjectStore, so it should have markAsClosing too
      (this.syncactionStore as any).markAsClosing?.();
    }
