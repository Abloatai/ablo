...
import type { MutatorDefs, MutatorFn } from '../mutators/defineMutators';
import { createTransaction } from '../mutators/Transaction';
import { createRecordingTransaction } from '../mutators/RecordingTransaction';
import type { UndoScope } from '../mutators/UndoManager';
        ...
        invokers[mutatorName] = async (args: unknown) => {
          ...
          if (undoScope) {
            ...
            try {
              ...
              console.error(`[useMutators] mutator "${label}" threw:`, err);
              throw err;
            }
          }
